...
export default function FooterSection({
  tagline = "Building the future of web components.",
  status = [
    { text: "1M+", subtext: "Users" },
    { text: "500+", subtext: "Open Source Projects" },
    { text: "99.99%", subtext: "Uptime" },
  ],
  menuItems = [
    {
      title: "Product",
  ...
  tagline?: string;
  status?: { text: string; subtext: string }[];
  menuItems?: MenuItem[];
  copyright?: string;
